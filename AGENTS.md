...
This file is the persistent context for Codex working on this project. Read it fully at the start of every session before making changes.
...
| AI orchestration | `@anthropic-ai/Codex-agent-sdk` | V1 `query()` API |
...
- **Diagnosis** — Codex's classified analysis of one failure
- **Classification** — `real-bug | test-bug | flaky | env-issue`
